    ...
    class FormSelect extends Component {
        ...
        _setupDropdown() {
            ...
            if (this.searchable) {
                ...
                var element = $(
                    '<div class="input-field col s12"><input type="text" placeholder = "' + placeholder +'" class="dropDownsearch browser-default inp" autocomplete="off" id="' +
                        searchinput +
                        '"></div>'
                );
            ...
            if (this.$selectOptions.length) {
                this.$selectOptions.each((el) => {
                    if ($(el).is("option")) {
                        ...
                        let optionEl;
                        if (this.isMultiple) {
                            optionEl = this._appendOptionWithIcon(
                                this.$el,
                                el,
                                "multiple"
                            );
                ...
                dropdownOptions.onOpenEnd = (el) => {
                    ...
                    if (selectedOption.length) {
                        ...
                        if (this.dropdown.isScrollable) {
                            ...
                            scrollOffset -=
                                this.dropdownOptions.clientHeight / 2; // center in dropdown
