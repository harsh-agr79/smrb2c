...
@section('main')
                    ...
                    <tbody>
                        @foreach ($data as $item)
                            <tr class="@if ($item->seen == '') z-depth-2 @endif"
                                @if ($item->mainstatus == 'blue') oncontextmenu="rightmenu({{ $item->order_id }}); return false;"" @endif
                                ...
                                <td class="iphone"><a class="modal-trigger btn-flat" href="#menumodal"
                                        onclick="changelink('/editorder/{{ $item->order_id }}','/deleteorder/{{ $item->order_id }}')"><i
    ...
    <script>
        function rightmenu(order_id) {
            ...
            $('#rmeditlink').attr('href', '/marketer/editorder/' + order_id);
            $('#rmdeletelink').attr('href', '/marketer/deleteorder/' + order_id);
        }
        ...
        function opendetail(order_id, seen, ms) {
            window.open('/marketer/detail/' + order_id, "_self");
        }
    </script>
    <script>
